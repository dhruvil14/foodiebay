...
<div class="portfolio s5" id="portfolio">
  <div  id="main_wrap">
    ...
    <div class="tab_topbox">
      <div class="tab_imgbox"><img src="img/baby-dragon-logo.jpg"> </div>
      <div class="tab_cont">
...
$myvar=  $date->format( 'Y-m-d H:i:s' );
        ...
        <?php echo $row['address']; ?></span>
            ...
            <div> <span class="span_font"> Min. Order </span> <span class="span_space1"> 250 </span> </div>
          ...
          <div class="info_rightbox">
            <div class="map_box"><div style="width: 350px"><iframe width="350" height="300" src="http://regiohelden.de/google-maps/map_en.php?width=600&amp;height=300&amp;hl=en&amp;q=sec%2058%2C%20noida%2C%20uttar%20pradesh%20%2Cindia+(Foodi)&amp;ie=UTF8&amp;t=&amp;z=14&amp;iwloc=A&amp;output=embed" frameborder="0" scrolling="no" marginheight="0" marginwidth="0"><a href="http://www.regiohelden.de/google-maps/">Google Maps Generator</a> von <a href="http://www.cssfounder.com/">cssfounder</a></iframe><br /><span style="font-size: 9px;"><a href="http://www.regiohelden.de/google-maps/" style="font-size: 9px;">Google Maps Generator</a> by <a href="http://www.regiohelden.de/" style="font-size: 9px;">cssfounder.com</a></span></div></div>
		...
		if(isset($_POST['submit1']))
		{
		 ...
		 $rev=$_POST['rev'];
			$insert="insert into review (userid,name,review) values ('$id','$name','$rev')";
              ...
              <?php  if(isset($_SESSION['usr_id']))
{
	?>
           ...
           <?php $sql1="select * from review order by id desc limit 10" ;
